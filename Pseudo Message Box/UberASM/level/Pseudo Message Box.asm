	...
	!BoxXstartRam		=	$0F42|!addr
	!BoxXendRam		=	$0F43|!addr
	!BoxYstartRam		=	$0F44|!addr
	!BoxYendRam		=	$0F45|!addr
	...
	!MsgXPosRam		=	$0F3A|!addr
	!MsgYPosRam		=	$0F3B|!addr
	!MsgWidthRam		=	$0F3C|!addr
	!MsgHeightRam		=	$0F3D|!addr
...
.BoxX<Width>
	LDX !ControlBox
	LDA #<Xstart1> : SEC : SBC .BoxXTable<Width>,x
	STA !BoxXstartRam
	LDA #<Xstart1>-1 : CLC : ADC .BoxXTable<Width>,x
	STA !BoxXendRam
	RTS
endmacro
...
.BoxY<Height>
	LDX !ControlBox
	LDA #<Ystart1> : SEC : SBC .BoxYTable<Height>,x
	STA !BoxYstartRam
	LDA #<Ystart1>-1 : CLC : ADC .BoxYTable<Height>,x
	STA !BoxYendRam
	RTS
endmacro
...
....ChangeColor
	LDA #%00011100 : TRB !ControlBox	; Clear CCC from yxpCCCtt
	...
	INC !Pointer
	SEP #$20
	JMP ...Middle				; This character isn't appear to message box.
...
.EraseLoop
	...
	RTL
.EraseTable
	db %01010000,%10100000,%01000100,%00000000,$FC,%00111000
