...
.MessageStripe
	...
	LDY #$0012
	LDA [!Table_Index],y
	STA !ControlBox		; !ControlBox = YXPCCCTT pointer.
...
...Middle						; = Message Box's second ~ above the last line
	PLY
	LDA !MsgWidthRam
	CMP #$01
	BNE +
...
....Text
	...
	LDA [!Table_Index],y			; Load Character
...
....ChangeColor
	...
	LDA [!Table_Index],y : AND #%00000111	; $F0~$F7 to $00~$07
...
...Bottom						; = Message Box's last line
	LDA !MsgWidthRam
	CMP #$01
	BNE +
	JMP ....BorderDR
